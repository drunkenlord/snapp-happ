...
let argv = yargs
			...
			.alias('logdir','l')
			.describe('metadir','Output metadata directory')
			.alias('metadir','m')
...
const config = require(__dirname + "/lib/metadata.js").configVars(argv.conf, METADIR, LOGDIR);
for (key in config) {
